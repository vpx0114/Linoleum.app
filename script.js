...
async function addKeldi(){
  ...
  if(product){
    ...
    product = {id: 'prod_' + Date.now(), name, doc, price, qty, image: null};
      ...
      row.innerHTML = `
        <div class="movement-left">
          ...
          <div class="movement-info">
            ...
            <div class="movement-meta">${escapeHtml(m.doc || '—')} · ${dateStr}</div>
          </div>
        </div>
